...
const WELCOME: Message = {
  role: "assistant",
  content:
    "Hi! I'm **Budgetly Support** 👋 Our team is available weekdays 08:00–17:00 SAST. In the meantime, I can help you with questions about the app, budgeting, or how to reach us. How can I help?",
};
        ...
        <div className="fixed bottom-24 right-6 z-50 flex w-[min(380px,calc(100vw-1.5rem))] flex-col overflow-hidden rounded-3xl border bg-card shadow-[var(--shadow-glow)]">
          <div className="flex items-center gap-3 border-b bg-primary px-4 py-3">
            ...
            <div>
              ...
              <p className="text-xs text-primary-foreground/70">Off-hours virtual assistant</p>
            </div>
            <button
